...
class Brewery:
    ...
    def api_connection():
        parser = argparse.ArgumentParser(description='Finds breweries from entered city')
        parser.add_argument('city', metavar='city', type=str, help='Enter city')
        args = parser.parse_args()
        city = args.city.lower()
        response_API = requests.get('https://api.openbrewerydb.org/v1/breweries?by_city='+city)
