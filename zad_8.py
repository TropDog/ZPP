...
class Brewery:
    def __init__(self, id: str, name: str,
                 brewery_type: str, address_1: str,
                 address_2: str, address_3: str,
                 city: str, state_province: str,
    ...
    def __str__(self):
        ...
        {self.address_2}, {self.address_3}, {self.city},
    ...
    def create_brewery(id, name, brewery_type, address_1, address_2, address_3,
                       city, state_province, postal_code, country, longitude,
                       latitude, phone, website_url, state, street):
        return Brewery(id, name, brewery_type, address_1, address_2, address_3,
                       city, state_province, postal_code, country, longitude,
                       latitude, phone, website_url, state, street)

    def api_connection():
        parser = argparse.ArgumentParser(
            description='Finds breweries from entered city')
        parser.add_argument('city', metavar='city',
                            type=str, help='Enter city')
...
for brewery in Brewery.api_connection():
    new_brewery = Brewery.create_brewery(brewery['id'],
                                         brewery['name'],
