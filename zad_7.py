...
class Brewery:
    ...
    def api_connection():
        response_API = requests.get(
            'https://api.openbrewerydb.org/v1/breweries/random?size=20')
...
for brewery in Brewery.api_connection():
    new_brewery = Brewery.create_brewery(brewery['id'], brewery['name'],
